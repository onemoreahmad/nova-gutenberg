...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-NovaGutenberg', __webpack_require__(3));
    Vue.component('detail-NovaGutenberg', __webpack_require__(6));
    Vue.component('form-NovaGutenberg', __webpack_require__(9));
});
...
var update = __webpack_require__(13)("e5d016e6", content, false, {});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        ...
        if (!Laraberg.editor) {
            ...
            setTimeout(function () {
                Laraberg.setContent(_this.field.value || "");
            }, 0);
        }
    },
    ...
    [
      _c("template", { slot: "field" }, [
        _c(
          "div",
          {
            class: _vm.direction === "rtl" ? "rtl-direction" : "ltr-direction"
          },
          [
            _c("textarea", {
              ref: "content",
