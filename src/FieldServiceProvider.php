...
class FieldServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        Nova::serving(function (ServingNova $event) {
            ...
            Nova::script("nova-gutenberg-dom", "https://unpkg.com/react-dom@16.8.6/umd/react-dom.production.min.js");
...
//            Nova::script("nova-gutenberg-react", "https://unpkg.com/react@16.`.3/umd/react.production.min.js");
